...
AppId={{2A56C3B4-F3B8-4174-AF15-18C1DB5195CB}       
AppName={#MyAppName}
...
Name: "msvc2015redist"; Description: "Install Microsoft VS2015 Redistributable";
...
Source: "./{#MyAdditionToolsFolder}/redist/MSVC2015Redist/*"; DestDir: "{tmp}"; Flags: ignoreversion
...
Filename: "{tmp}\vc_redist.x86.exe"; Parameters: /silent; StatusMsg: "Installing Microsoft VS2015 Redistributable"; Tasks: msvc2015redist;
